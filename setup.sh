...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW}                    📔 SSH KEY SETUP (WICHTIG!)${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${BOLD}Auf deinem LOKALEN Computer (nicht auf diesem Server!):${NC}"
echo ""
echo -e "${CYAN}1. SSH-Key erstellen (falls noch nicht vorhanden):${NC}"
echo -e "   ${GREEN}ssh-keygen -t ed25519 -C \"your-email@example.com\"${NC}"
echo -e "   ${YELLOW}→ Speicherort bestätigen (Enter)${NC}"
echo -e "   ${YELLOW}→ Passphrase eingeben (optional aber empfohlen)${NC}"
echo ""
echo -e "${CYAN}2. Public Key anzeigen:${NC}"
echo -e "   ${GREEN}cat ~/.ssh/id_ed25519.pub${NC}"
echo ""
echo -e "${CYAN}3. Public Key auf DIESEM Server hinzufügen:${NC}"
echo -e "   ${YELLOW}Option A: Von deinem lokalen Computer aus:${NC}"
echo -e "   ${GREEN}ssh-copy-id -p 4848 root@$PUBLIC_IP${NC}"
echo ""
echo -e "   ${YELLOW}Option B: Manuell auf diesem Server (copy & paste):${NC}"
echo -e "   ${GREEN}mkdir -p ~/.ssh${NC}"
echo -e "   ${GREEN}chmod 700 ~/.ssh${NC}"
echo -e "   ${GREEN}echo \"DEIN-PUBLIC-KEY-HIER\" >> ~/.ssh/authorized_keys${NC}"
echo -e "   ${GREEN}chmod 600 ~/.ssh/authorized_keys${NC}"
echo ""
echo -e "${CYAN}4. SSH-Config auf lokalem Computer (optional aber praktisch):${NC}"
echo -e "   ${GREEN}echo \"Host vps\" >> ~/.ssh/config${NC}"
echo -e "   ${GREEN}echo \"  HostName $PUBLIC_IP\" >> ~/.ssh/config${NC}"
echo -e "   ${GREEN}echo \"  Port 4848\" >> ~/.ssh/config${NC}"
echo -e "   ${GREEN}echo \"  User root\" >> ~/.ssh/config${NC}"
echo -e "   ${GREEN}echo \"  IdentityFile ~/.ssh/id_ed25519\" >> ~/.ssh/config${NC}"
echo ""
echo -e "   ${YELLOW}Dann kannst du dich einfach verbinden mit:${NC} ${GREEN}ssh vps${NC}"
echo ""
echo -e "${RED}⚠ WARNUNG:${NC} Ohne SSH-Key könntest du dich nach einem Reboot aussperren!"
echo -e "${YELLOW}           Stelle SICHER, dass der SSH-Key funktioniert BEVOR du rebootest!${NC}"
echo ""
echo -e "${CYAN}Test-Befehl (in neuem Terminal):${NC}"
echo -e "  ${GREEN}ssh -p 4848 -i ~/.ssh/id_ed25519 root@$PUBLIC_IP${NC}"
echo ""
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
if [ -f ~/.ssh/authorized_keys ] && [ -s ~/.ssh/authorized_keys ]; then
    ...
    echo -e "${GREEN}✓ Du hast bereits $KEY_COUNT SSH-Key(s) konfiguriert${NC}"
    echo ""
else
    echo -e "${RED}✗ KEINE SSH-Keys gefunden!${NC}"
    echo -e "${YELLOW}  Bitte JETZT einen SSH-Key einrichten bevor du rebootest!${NC}"
    echo ""
fi
